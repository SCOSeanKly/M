...
public extension View {
    @ViewBuilder
    func scrollStatusMonitorSK(_ isScrolling: Binding<Bool>, monitorMode: ScrollStatusMonitorMode) -> some View {
        switch monitorMode {
        case .common:
    ...
    init() {
        cancellable = publisher
            ...
            .sink(receiveCompletion: { _ in }, receiveValue: { output in
                ...
                if value == 1 && self.previousOffset <= 0 {
